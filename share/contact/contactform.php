...
$formproc->AddRecipient('qmc.qal@gmail.com'); //<<---Put your email address here
$formproc->AddRecipient('mc@quality-thailand.com');

//2. For better security. Get a random tring from this link: http://tinyurl.com/randstr
// and put it here
$formproc->SetFormRandomKey('Mvcx7Bnsazu9PZN');
...
<!-- Form Code Start -->
<form action='<?php echo $formproc->GetSelfScript(); ?>' method='post' id='contactus' accept-charset='UTF-8'>
<fieldset >
...
<div class='container'>
    <label for='message' >List measurement/model/serial/range:</label><br/>
    <span id='contactus_message_errorloc' class='error'></span>
    <textarea rows="10" cols="50" name='message' id='message'><?php echo $formproc->SafeDisplay('message') ?></textarea>
</div>
<fieldset id='antispam'>
<legend >Anti-spam question</legend>
<span class='short_explanation'>(Please answer the simple question below before submitting.)</span>
<div class='container'>
...
<div align="center"><!-- client-side Form Validations:
